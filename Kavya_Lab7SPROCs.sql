...
ALTER PROCEDURE proj01_insert_xport
@VeName varchar(50),
@RouName varchar(50),
@EFName varchar(50),
@ELName varchar(50),
...
BEGIN TRAN T1
INSERT INTO tblTRANSPORTATION(VehicleID, RouteID, EmployeeID, transportationName)
	VALUES (@V_ID, @R_ID, @E_ID, @TName)
...
DECLARE @randomDummy varchar(30)
DECLARE @VN varchar(50), @RN varchar(30), @EFN varchar(30), @ELN varchar(30), @EDOB Date, @TN varchar(30)
...
BEGIN
    ...
    SET @randomDummy = (SELECT RAND() * 100000 + 1)
    SET @TN = convert(varchar, getdate(), 12) + ' ' + @randomDummy
